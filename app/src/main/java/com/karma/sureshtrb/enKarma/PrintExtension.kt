...
fun Canvas.drawMultilineText(
    ...
    val breakStrategy = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
        LineBreaker.BREAK_STRATEGY_SIMPLE
    } else {
        TODO("VERSION.SDK_INT < Q")
    } // Declare outside the builder chain
    val justificationMode = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    StaticLayout.Builder.obtain(text, start, end, textPaint, width)
        ...
        .setBreakStrategy(breakStrategy) // Pass as parameter
