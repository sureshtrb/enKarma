...
class SandyaVandanamActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //setContentView(R.layout.activity_sandya_vandanam)
...
//=====================================================================================================================
        ...
        val sandyaCombination = SpannableStringBuilder()
        sandyaCombination.append(hdSt1, bdSt0)
        if (sandyaType.equals("ப்ராத்தஸ்ந்தியா",true)) {
            sandyaCombination.append(comSt1A) }
        else if (sandyaType.equals("மாத்யாநிஹம்",true)) {
            sandyaCombination.append(comSt1B) }
        else {
            sandyaCombination.append(comSt1C)
        }
        //ப்ரோக்ஷணம்
        sandyaCombination.append(hdSt2AC)
        sandyaCombination.append(comSt2AC, bdSt1AC, comSt3AC, bdSt2AC, comSt4AC, bdSt3AC, comSt5AC, bdSt4AC, comSt6AC, bdSt5AC,
        ...
        sandyaCombination.append(hdSt2GM, comSt16GM, bdSt15GM)
        //ப்ராணாயாமம்
        sandyaCombination.append(hdSt3PM, comSt17PM, bdSt16PM, comSt18PM, bdSt17PM)
        //ஸங்கல்பம்
        sandyaCombination.append(hdSt4SANG, comSt19SANG, bdSt18SANG)
        sandyaCombination.append(comSt2, bdSt1, hdSt2, comSt3, bdSt2, comSt4, bdSt3, comSt5, bdSt4)
        //ப்ரோக்ஷணம்
        sandyaCombination.append(hdSt25A, comSt1PRO, bdSt1PRO, comSt2PRO, bdSt2PRO)
        //பாபவிஸர்ஜனம்
        sandyaCombination.append(hdSt1PV, comSt1PV, bdSt1PV, comSt2PV, bdSt2PV, comSt3PV, bdSt3PV, comSt6,bdSt5)
        //ப்ராசனம்
        sandyaCombination.append(hdSt3, comSt7)
        if (sandyaType.equals("ப்ராத்தஸ்ந்தியா",true)) {
            sandyaCombination.append(bdSt6A) }
        else if (sandyaType.equals("மாத்யாநிஹம்",true)) {
            sandyaCombination.append(bdSt6B) }
        else {
            sandyaCombination.append(bdSt6C)
        }
        //ஆசமனம்
        sandyaCombination.append(hdSt25B, comSt2ACA, bdSt1ACA, comSt3ACA, bdSt2ACA, comSt4ACA, bdSt3ACA, comSt5ACA, bdSt4ACA,
        ...
        sandyaCombination.append(hdSt4, comSt13, bdSt1PROA, hdSt5, comSt8, bdSt7, comSt9, bdSt8, comSt10, bdSt9, comSt11, bdSt10, comSt12, bdSt11)
        sandyaCombination.append(hdSt9, comSt13, bdSt12)
        sandyaCombination.append(hdSt10, comSt14, bdSt13, comSt15, bdSt14, comSt16, bdSt15)
        sandyaCombination.append(hdSt11, comSt17, bdSt16)
        if (sandyaType.equals("ப்ராத்தஸ்ந்தியா",true)) {
            sandyaCombination.append(comSt18A)
        }else if (sandyaType.equals("மாத்யாநிஹம்",true)) {
            sandyaCombination.append(comSt18B)
        }else {
            sandyaCombination.append(comSt18C)
        }
        sandyaCombination.append(bdSt17)
        //ப்ராணாயாமம்
        sandyaCombination.append(hdSt3PMA, comSt17PM, bdSt16PMA, comSt18PMA, bdSt17PMA)
        //ஸங்கல்பம்
        sandyaCombination.append(hdSt4SANGA, comSt19SANG, bdSt18)
        if (sandyaType.equals("ப்ராத்தஸ்ந்தியா",true)) {
            sandyaCombination.append(bdSt19A)
        }else if (sandyaType.equals("மாத்யாநிஹம்",true)) {
            sandyaCombination.append(bdSt19B)
        }else {
            sandyaCombination.append(bdSt19C)
        }
        sandyaCombination.append(bdSt20, hdSt12, comSt19, bdSt21)
        sandyaCombination.append(hdSt13, comSt20, bdSt22, comSt21, bdSt23)
        sandyaCombination.append(hdSt14, comSt22, bdSt24)
        //ஆசமனம்
        sandyaCombination.append(hdSt25C, comSt2ACC, bdSt1ACC, comSt3ACC, bdSt2ACC, comSt4ACC, bdSt3ACC, comSt5ACC, bdSt4ACC, comSt6ACC,
        ...
        sandyaCombination.append(hdSt15, comSt23, bdSt25)
        //ஆசமனம்
        sandyaCombination.append(hdSt25D, comSt2ACB, bdSt1ACB, comSt3ACB, bdSt2ACB, comSt4ACB, bdSt3ACB, comSt5ACB, bdSt4ACB, comSt6ACB,
        ...
        if (sandyaType.equals("ப்ராத்தஸ்ந்தியா",true)) {
            sandyaCombination.append(hdSt16, comSt24A, bdSt26, comSt25, bdSt27, comSt26, bdSt28, comSt27, bdSt29, comSt28, bdSt30, comSt29,
        ...
        sandyaCombination.append("\n")
        binding.sandyaVandanamTextView.text = sandyaCombination
        class MyPrintDocumentAdapter(private var context: Context) : PrintDocumentAdapter() {
            ...
            private fun drawPage(page: PdfDocument.Page, pagnumber: Int) {
                ...
                val pageTexts = arrayOf(
                    ...
                    sandyaCombination.subSequence(startPos3, endPos3),
                    sandyaCombination.subSequence(startPos4, endPos4),
                    sandyaCombination.subSequence(startPos5, endPos5),
                    sandyaCombination.subSequence(startPos6, endPos6),
                    sandyaCombination.subSequence(startPos7, endPos7),
                    sandyaCombination.subSequence(startPos8, endPos8),
                    sandyaCombination.subSequence(startPos9, endPos9),
                    sandyaCombination.subSequence(startPos10, endPos10),
                    sandyaCombination.subSequence(startPos11, endPos11),
                    sandyaCombination.subSequence(startPos12, endPos12),
                    sandyaCombination.subSequence(startPos13, endPos13),
                    sandyaCombination.subSequence(startPos14, endPos14),
                    sandyaCombination.subSequence(startPos15, endPos15),
                ...
                */
                ...
                footerText1.setSpan(AbsoluteSizeSpan(13, true), 0, footerText1.length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                footerText1.setSpan(StyleSpan(Typeface.ITALIC), 0, footerText1.length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                footerText1.setSpan(ForegroundColorSpan(Color.RED), 0, footerText1.length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                val footerText = footerText1.toString()

                if (pagnumber in 0 until totalpages && pagnumber < pageTexts.size) { // pagenumber starts from 0
                    pageTexts[pagnumber].let { text ->
                        val mTextLayout = StaticLayout.Builder
                            .obtain(text, 0, text.length, mTextPaint, canvas.width)
        ...
        printBtn.setOnClickListener {
            ...
            for (page in 1..totalpages) {
                val startLine = (page - 1) * linesPerPage
                val endLine = minOf(startLine +linesPerPage, mTLineCount) - 1

                startPositions.add(binding.sandyaVandanamTextView.layout.getLineStart(startLine))
                endPositions.add(binding.sandyaVandanamTextView.layout.getLineEnd(endLine))
            }
            ...
            /* if (totalpages == 1) {
                 ...
                 //   pageOneText = sandyaVandanamTextView.text.toString().substring(startPos1, endPos1)
             }
             if (totalpages == 2) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount >= 50) {
                      endPos1 = sandyaVandanamTextView.layout.getLineEnd(50)
                  } else {
                      endPos1 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  }
                  //     pageOneText = sandyaVandanamTextView.text.toString().substring(startPos1, endPos1)
                  if (mTLineCount in 51..100) {
                      startPos2 = sandyaVandanamTextView.layout.getLineStart(51)
                      endPos2 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos2 = sandyaVandanamTextView.layout.getLineStart(51)
                      endPos2 = sandyaVandanamTextView.layout.getLineEnd(100)
                  }
                  //      pageTwoText = sandyaVandanamTextView.text.toString().substring(startPos2, endPos2)
              }
             if (totalpages == 3) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount >= 50) {
                  ...
                  if (mTLineCount in 101..150) {
                      startPos3 = sandyaVandanamTextView.layout.getLineStart(101)
                      endPos3 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos3 = sandyaVandanamTextView.layout.getLineStart(101)
                      endPos3 = sandyaVandanamTextView.layout.getLineEnd(150)
                  }
                  //    pageThreeText = sandyaVandanamTextView.text.toString().substring(startPos3, endPos3)
              }
              if (totalpages == 4) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount >= 50) {
                  ...
                  if (mTLineCount in 151..200) {
                      startPos4 = sandyaVandanamTextView.layout.getLineEnd(151)
                      endPos4 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos4 = sandyaVandanamTextView.layout.getLineEnd(151)
                      endPos4 = sandyaVandanamTextView.layout.getLineEnd(200)
                  }
                  //    pageFourText = sandyaVandanamTextView.text.toString().substring(startPos4, endPos4)
              }
              if (totalpages == 5) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount >= 50) {
                  ...
                  if (mTLineCount in 201..250) {
                      startPos5 = sandyaVandanamTextView.layout.getLineEnd(201)
                      endPos5 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos5 = sandyaVandanamTextView.layout.getLineEnd(201)
                      endPos5 = sandyaVandanamTextView.layout.getLineEnd(250)
                  }
                  //    pageFiveText = sandyaVandanamTextView.text.toString().substring(startPos5, endPos5)
              }
              ...
              if (totalpages == 6) {
                  ...
                  if (mTLineCount in 251..300) {
                      startPos6 = sandyaVandanamTextView.layout.getLineStart(251)
                      endPos6 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos6 = sandyaVandanamTextView.layout.getLineStart(251)
                      endPos6 = sandyaVandanamTextView.layout.getLineEnd(300)
                  }
                  //    pageSixText = sandyaVandanamTextView.text.toString().substring(startPos6, endPos6)
              }
              if (totalpages == 7) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount >= 50) {
                  ...
                  if (mTLineCount in 301..350) {
                      startPos7 = sandyaVandanamTextView.layout.getLineStart(301)
                      endPos7 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos7 = sandyaVandanamTextView.layout.getLineStart(301)
                      endPos7 = sandyaVandanamTextView.layout.getLineEnd(350)
                  }
                  //    pageSevenText = sandyaVandanamTextView.text.toString().substring(startPos7, endPos7)
              }
             if (totalpages == 8) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount >= 50) {
                  ...
                  if (mTLineCount in 351..400) {
                      startPos8 = sandyaVandanamTextView.layout.getLineStart(351)
                      endPos8 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                      println("endPos8 : $endPos8")
                  } else {
                      startPos8 = sandyaVandanamTextView.layout.getLineStart(351)
                      endPos8 = sandyaVandanamTextView.layout.getLineEnd(400)
                      println("endPos82 : $endPos8")
                  }
                  println("startPos8 : $startPos8")
                  println("endPos8F : $endPos8")
                  //    pageEightText = sandyaVandanamTextView.text.toString().substring(startPos8, endPos8)
              }
              ...
              if (totalpages == 9) {
                  ...
                  if (mTLineCount in 401..450) {
                      startPos9 = sandyaVandanamTextView.layout.getLineStart(401)
                      endPos9 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos9 = sandyaVandanamTextView.layout.getLineStart(401)
                      endPos9 = sandyaVandanamTextView.layout.getLineEnd(450)
                  }
                  //     pageNineText = sandyaVandanamTextView.text.toString().substring(startPos9, endPos9)
              }
              if (totalpages == 10) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount >= 50) {
                  ...
                  if (mTLineCount  in 451..500) {
                      startPos10 = sandyaVandanamTextView.layout.getLineStart(451)
                      endPos10 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos10 = sandyaVandanamTextView.layout.getLineStart(451)
                      endPos10 = sandyaVandanamTextView.layout.getLineEnd(500)
                  }
                  //    pageTenText = sandyaVandanamTextView.text.toString().substring(startPos10, endPos10)
              }
              if (totalpages == 11) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount  >= 50) {
                  ...
                  if (mTLineCount  in 501..550) {
                      startPos11 = sandyaVandanamTextView.layout.getLineStart(501)
                      endPos11 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos11 = sandyaVandanamTextView.layout.getLineStart(501)
                      endPos11 = sandyaVandanamTextView.layout.getLineEnd(550)
                  }
                  //    pageElevenText = sandyaVandanamTextView.text.toString().substring(startPos11, endPos11)
              }
              if (totalpages == 12) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount >= 50) {
                  ...
                  if (mTLineCount  in 551..600) {
                      startPos12 = sandyaVandanamTextView.layout.getLineStart(551)
                      endPos12 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos12 = sandyaVandanamTextView.layout.getLineStart(551)
                      endPos12 = sandyaVandanamTextView.layout.getLineEnd(600)
                  }
                  //    pageTwelveText = sandyaVandanamTextView.text.toString().substring(startPos12, endPos12)
              }
              if (totalpages == 13) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount >= 50) {
                  ...
                  if (mTLineCount in 601..650) {
                      startPos13 = sandyaVandanamTextView.layout.getLineStart(601)
                      endPos13 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos13 = sandyaVandanamTextView.layout.getLineStart(601)
                      endPos13 = sandyaVandanamTextView.layout.getLineEnd(650)
                  }
                  //    pageThirteenText = sandyaVandanamTextView.text.toString().substring(startPos13, endPos13)
              }
              if (totalpages == 14) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount >= 50) {
                  ...
                  if (mTLineCount in 651..700) {
                      startPos14 = sandyaVandanamTextView.layout.getLineStart(651)
                      endPos14 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos14 = sandyaVandanamTextView.layout.getLineStart(651)
                      endPos14 = sandyaVandanamTextView.layout.getLineEnd(700)
                  }
                  //    pageFourteenText = sandyaVandanamTextView.text.toString().substring(startPos14, endPos14)
              }
              if (totalpages == 15) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount >= 50) {
                  ...
                  if (mTLineCount in 701..750) {
                      startPos15 = sandyaVandanamTextView.layout.getLineStart(701)
                      endPos15 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos15 = sandyaVandanamTextView.layout.getLineStart(701)
                      endPos15 = sandyaVandanamTextView.layout.getLineEnd(750)
                  }
                  //    pageFifteenText = sandyaVandanamTextView.text.toString().substring(startPos15, endPos15)
              }
              if (totalpages == 16) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount >= 50) {
                  ...
                  if (mTLineCount in 751..800) {
                      startPos16 = sandyaVandanamTextView.layout.getLineStart(751)
                      endPos16 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos16 = sandyaVandanamTextView.layout.getLineStart(751)
                      endPos16 = sandyaVandanamTextView.layout.getLineEnd(800)
                  }
                  //    pageSixteenText = sandyaVandanamTextView.text.toString().substring(startPos16, endPos16)
              }
              if (totalpages == 17) {
                  startPos1 = sandyaVandanamTextView.layout.getLineStart(0)
                  if (mTLineCount >= 50) {
                  ...
                  if (mTLineCount in 801..850) {
                      startPos17 = sandyaVandanamTextView.layout.getLineStart(801)
                      endPos17 = sandyaVandanamTextView.layout.getLineEnd(mTLineCount-1)
                  } else {
                      startPos17 = sandyaVandanamTextView.layout.getLineStart(801)
                      endPos17 = sandyaVandanamTextView.layout.getLineEnd(850)
                  }
                  //    pageSeventeenText = sandyaVandanamTextView.text.toString().substring(startPos17, endPos17)
              }*/
