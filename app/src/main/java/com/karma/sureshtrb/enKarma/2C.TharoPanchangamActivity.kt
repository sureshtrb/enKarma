...
StrictMode.setThreadPolicy(policy)
       ...
       // Assuming your layout file is activity_tharo_panchangam.xml
// and your binding object is named binding

val dateText = binding.textViewDate1
val changeDateBtn = binding.buttonDate1
place = binding.GEOLOCATION.text.toString()
Varusham = binding.Year.text.toString()
ayyanamm = binding.Ayana.text.toString()
kalam = binding.Season.text.toString()
rasee = binding.Rasi.text.toString()
baksham = binding.Paksha.text.toString()
todThithi = binding.Thithi.text.toString()
kizhamai = binding.Day.text.toString()
nachathirm = binding.Natchatram.text.toString()
yog = binding.Yogam.text.toString()
kar = binding.Karanam.text.toString()
val rg1 = binding.radioGroup1
val rg2 = binding.radioGroup2
val rg3 = binding.radioGroup3
val rg4 = binding.radioGroup4
val proceed = binding.Proceed
val rbFLiving = binding.radio1G1
val rbFDeceased = binding.radio2G1
val rbMLiving = binding.radio1G2
val rbMDeceased = binding.radio2G2
val rbMMLiving = binding.radio1G3
val rbMMDeceased = binding.radio2G3
val rbFMLiving = binding.radio1G4
val rbFMDeceased = binding.radio2G4
...
*/
    ...
    fun buttonClicked(button: Button){
        ...
        if (button.isPressed) { // Added conditional block
            parseWeb()
            nextDayparseWeb()
            pradamaiDayparseWeb()
        }
