...
class GayathriJapamActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        */
        ...
        val comSt1 = SpannableString("(காயத்ரீ ஜபத்தை காலை/மதியம்-கிழக்கு; மாலை-மேற்கு)\n")
        comSt1.setSpan(AbsoluteSizeSpan(10,true),start,comSt1.length,exExFlag)
        comSt1.setSpan(StyleSpan(Typeface.ITALIC), start, comSt1.length, exExFlag)
        comSt1.setSpan(ForegroundColorSpan(Color.DKGRAY),start,comSt1.length,exExFlag)

        val hdSt1 = SpannableString("ஆசமனம்\n")
        hdSt1.setSpan(AbsoluteSizeSpan(16, true), start, hdSt1.length, exExFlag)
        ...
        comSt2.setSpan(AbsoluteSizeSpan(10,true),start,comSt2.length,exExFlag)
        ...
        val bdSt1 = SpannableString("- ஓம் அச்யுதாய நம: |  ஓம் அனந்தாய நம: |  ஓம் கோவிந்தாய நம: ||")
        bdSt1.setSpan(AbsoluteSizeSpan(12, true), start, bdSt1.length, exExFlag)
        ...
        val comSt3 = SpannableString("\n(ஒரு உத்தரிணி ஜலம் எடுத்து வலது கையில் விட்டு கீழே விடவும்)")
        comSt3.setSpan(AbsoluteSizeSpan(10,true),start,comSt3.length,exExFlag)
        ...
        val bdSt2 = SpannableString("- அபஉபஸ்ப்ருஸ்ய ||\n")
        bdSt2.setSpan(AbsoluteSizeSpan(12, true), start, bdSt2.length, exExFlag)
        ...
        val comSt20 = SpannableString("-(ஜலத்தால் கைகளை துடைத்துக் கொள்ளவும்)\n\n (எழுந்து நின்று கைகூப்பி ப்ராத்தித்து நமஸ்கரிக்கவும்)\n")
        ...
        val bdSt19 = SpannableString("   ஆப்ரம்ம லோகாத் ஆசேஷாத்\nஆலோகாலோகபர்வதாத் |\n   யே வஸந்தி த்விஜா தேவா: \nதேப்யோ நித்யம் நமோ நம: ||\nநமோ ப்ரம்மண்ய தேவாய \nகோப்ராம்மண ஹிதாய ச |\nஜகத்திதாய க்ருஷ்ணாய \nகோவிந்தாய நமோ நம: ||\n")
        ...
        bdSt19.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt19.length, exExFlag)
        ...
        hdSt5A.setSpan(ForegroundColorSpan(Color.parseColor("#8b008b")), start,  hdSt5A.length, exExFlag)
        ...
        bdSt20G.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt20G.length, exExFlag)

        val bdSt20H = SpannableString("\n   அபிவாதயே yourPravaras ப்ரவரான்வித: yourGothram கோத்ர: காத்யாயன ஸூத்ர: ஸ்ரீஶுக்ல யஜூர் வேத காண்வஶாகாத்யாயீ ஸ்ரீ yourName ஶர்மா நாமாஹம் அஹம் அஸ்மி போ:|\n")
        ...
        bdSt20K.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt20K.length, exExFlag)
        ...
        val bdSt25 = SpannableString("கூர்மாஸனாய நம: அனந்தாஸனாய நம: பத்மாஸனாய நம: \nகருடாஸனாய நம:ஸிம்மாஸனாய நம: ||   " +
        ...
        val comSt26 = SpannableString("-கையை சொடுக்கிய படியே தலையைச் சுற்றி கையைத் தட்டவும்\nகை கூப்பி- ")
        ...
        hdSt3A.setSpan(ForegroundColorSpan(Color.parseColor("#8b008b")), start,  hdSt3A.length, exExFlag)
        ...
        val bdSt30 = SpannableString("பூராதி ஸப்தவ்யாஹ்ருதீனாம் அத்ரிப்ருகு குத்ஸ வஸிஷ்ட கௌதம காச்யப ஆங்கிரஸா ரிஷய: |")
        ...
        val bdSt31 = SpannableString("காயத்ரீ உஷ்ணிக் அனுஷ்டுப் ப்ருஹதீ பங்க்தி த்ரிஷ்டுப் ஜகத்யஸ் ச்சந்தாம்ஸி |")
        ...
        hdSt3B.setSpan(ForegroundColorSpan(Color.parseColor("#8b008b")), start,  hdSt3B.length, exExFlag)

        val bdSt16A = SpannableString("\nஓம் பூ: ஓம்புவா:\n   ஓம் ஸுவா: ஓம் மஹ: \nஓம் ஜன: ஓம் தப:\n   ஓம் ஸத்யம் ஓம் தத்ஸவிதுர் வரேண்யம் \n   பர்கோ தேவஸ்ய தீமஹி | \nதியோ யோந: ப்ரசோதயாத் |\n   ஓம் ஆபோ ஜ்யோதீரஸோ \nஅம்ருதம் ப்ரம்ம பூர்புவஸ்வரோம் ||\n")
        ...
        bdSt16A.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt16A.length, exExFlag)
        ...
        val bdSt43 = SpannableString("ஆவாஹனே வினியோக: ||\n" +
        ...
        bdSt51B.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt51B.length, exExFlag)
        ...
        bdSt51C.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt51C.length, exExFlag)
        ...
        bdSt54Missg.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt54Missg.length, exExFlag)
        ...
        bdSt56A.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt56A.length, exExFlag)
        ...
        bdSt57A.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt57A.length, exExFlag)
        ...
        bdSt58A.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt58A.length, exExFlag)
        ...
        bdSt59.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt59.length, exExFlag)
        ...
        bdSt59A.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt59A.length, exExFlag)
        ...
        bdSt60.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt60.length, exExFlag)
        ...
        bdSt60A.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt60A.length, exExFlag)

        val comSt38 = SpannableString("\nவலது கையை சொடுக்கிக் கொண்டே தலையை வலமாகச் சுற்றி இடக்கையில் தட்டவும்- ")
        ...
        bdSt61.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt61.length, exExFlag)

        val comSt39 = SpannableString("\nவலது கையை சொடுக்கிக் கொண்டே தலையை வலமாகச் சுற்றி இடக்கையில் தட்டவும்- ")
        ...
        bdSt62.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt62.length, exExFlag)
        ...
        hdSt10A.setSpan(ForegroundColorSpan(Color.parseColor("#8b008b")), start,  hdSt10A.length, exExFlag)
        ...
        val bdSt63 = SpannableString("முக்தாவித்ரும ஹேமநீல தவளச்\n" +
        ...
        bdSt63.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt63.length, exExFlag)
        ...
        hdSt11A.setSpan(ForegroundColorSpan(Color.parseColor("#8b008b")), start,  hdSt11A.length, exExFlag)
        ...
        bdSt64.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt64.length, exExFlag)
        ...
        bdSt65.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt65.length, exExFlag)
        ...
        bdSt66.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt66.length, exExFlag)
        ...
        bdSt67.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt67.length, exExFlag)
        ...
        bdSt68.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt68.length, exExFlag)
        ...
        bdSt69.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt69.length, exExFlag)
        ...
        bdSt70.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt70.length, exExFlag)

        val bdSt16B = SpannableString("\nஓம் பூ: ஓம்புவா:\n   ஓம் ஸுவா: ஓம் மஹ: \nஓம் ஜன: ஓம் தப:\n   ஓம் ஸத்யம் ஓம் தத்ஸவிதுர் வரேண்யம் \n   பர்கோ தேவஸ்ய தீமஹி | \nதியோ யோந: ப்ரசோதயாத் |\n   ஓம் ஆபோ ஜ்யோதீரஸோ \nஅம்ருதம் ப்ரம்ம பூர்புவஸ்வரோம் ||")
        ...
        bdSt16B.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt16B.length, exExFlag)
        ...
        bdSt17A.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt17A.length, exExFlag)
        ...
        hdSt9A.setSpan(ForegroundColorSpan(Color.parseColor("#8b008b")), start,  hdSt9A.length, exExFlag)

        val comSt38Add = SpannableString("\nவலது கையை சொடுக்கிக் கொண்டே தலையை வலமாகச் சுற்றி இடக்கையில் தட்டவும்- ")
        ...
        bdSt61Add.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt61Add.length, exExFlag)

        val comSt47 = SpannableString("\nவலது கையை சொடுக்கிக் கொண்டே இடமாகத் நலையைச் சுற்றி இடக்கையில் தட்டவும்- ")
        ...
        bdSt71.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt71.length, exExFlag)

        val bdSt72 = SpannableString("முக்தாவித்ரும ஹேமநீல தவளச் சாயையர் முகைஸ் த்ரீக்ஷணை:\n" +
        ...
        bdSt72.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt72.length, exExFlag)
        ...
        bdSt73.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt73.length, exExFlag)
        ...
        bdSt74.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt74.length, exExFlag)
        ...
        bdSt75.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt75.length, exExFlag)
        ...
        bdSt76.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt76.length, exExFlag)
        ...
        bdSt77.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt77.length, exExFlag)
        ...
        bdSt78.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt78.length, exExFlag)
        ...
        bdSt79.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt79.length, exExFlag)
        ...
        comSt49A.setSpan(ImageSpan(varuna), 9, 10, Spannable.SPAN_INCLUSIVE_INCLUSIVE)
        ...
        bdSt80.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt80.length, exExFlag)
        ...
        bdSt81.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt81.length, exExFlag)
        ...
        bdSt82.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt82.length, exExFlag)
        ...
        bdSt83.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt83.length, exExFlag)
        ...
        bdSt84.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt84.length, exExFlag)
        ...
        bdSt85.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt85.length, exExFlag)
        ...
        bdSt86.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt86.length, exExFlag)
        ...
        bdSt87.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt87.length, exExFlag)
        ...
        bdSt88.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt88.length, exExFlag)
        ...
        bdSt89.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt89.length, exExFlag)
        ...
        bdSt90.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt90.length, exExFlag)
        ...
        bdSt91.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt91.length, exExFlag)
        ...
        bdSt92.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt92.length, exExFlag)
        ...
        val bdSt93 = SpannableString("ஸந்த்யாயை நம: |\n காயத்ர்யை நம: |\nஸாவித்ர்யை நம: | ஸரஸ்வத்யை நம: |")
        ...
        bdSt93.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt93.length, exExFlag)
        ...
        bdSt94.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt94.length, exExFlag)
        ...
        bdSt95.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt95.length, exExFlag)
        ...
        val bdSt96 = SpannableString("யமாய தர்மராஜாய ம்ருத்யவே சாந்தகாய ச |\n" +
        ...
        bdSt96.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt96.length, exExFlag)
        ...
        val bdSt97 = SpannableString("ருதகும் ஸத்யம் பரம் ப்ரம்ஹ புருஷம் க்ருஷ்ண பிங்களம் |\n" +
        ...
        bdSt97.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt97.length, exExFlag)
        ...
        val bdSt98 = SpannableString("ஆகாசாத் பதிதம் தோயம் யதாகச்சதி ஸாகரம் |\n" +
        ...
        bdSt98.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt98.length, exExFlag)
        ...
        bdSt99.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt99.length, exExFlag)
        ...
        bdSt100.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt100.length, exExFlag)
        ...
        val bdSt101 = SpannableString("அப்ரோக்ஷிதே ஜபஸ்தானே \n   சுக்ரோ ஹரதித்ஜ்ஜபம் |\n    தன் மூலே ம்ருத்திகாம் \n   குர்யால்லலாடே திலகாக்ருதிம் ||")
        ...
        bdSt101.setSpan(ForegroundColorSpan(Color.parseColor("#0000ee")), start,  bdSt101.length, exExFlag)
        ...
        val gayathri_combination = SpannableStringBuilder()
        gayathri_combination.append(hdSt1, comSt1, comSt2, bdSt1, comSt3, bdSt2, comSt4, bdSt3, comSt5, bdSt4, comSt6, bdSt5)
        gayathri_combination.append(comSt7, bdSt6, comSt8, bdSt7, comSt9, bdSt8, comSt10, bdSt9, comSt11, bdSt10, comSt12, bdSt11)
        gayathri_combination.append(comSt13, bdSt12, comSt14, bdSt13, comSt15, bdSt14, hdSt2, comSt16, bdSt15, hdSt3, comSt17)
        gayathri_combination.append(bdSt16, comSt18, bdSt17, hdSt4, comSt19, bdSt18, comSt20, bdSt19, hdSt5, bdSt20, hdSt6, comSt21, bdSt21)
        gayathri_combination.append(comSt22, bdSt22, comSt23, bdSt23, comSt24, bdSt24, comSt25, bdSt25, comSt26, bdSt26, hdSt3A)
        gayathri_combination.append(comSt21, bdSt27, comSt22, bdSt28, comSt23, bdSt29, comSt21, bdSt30, comSt22, bdSt31, comSt23, bdSt32)
        gayathri_combination.append(comSt21, bdSt33, comSt22, bdSt34, comSt23, bdSt35, comSt21, bdSt36, comSt22, bdSt37, comSt23, bdSt38)
        gayathri_combination.append(comSt25, bdSt39, hdSt3B, comSt17Ten, bdSt16A, hdSt7, comSt21, bdSt40, comSt22, bdSt41, comSt23, bdSt42)
        gayathri_combination.append(comSt25, bdSt43, comSt21, bdSt44, comSt22, bdSt34, comSt23, bdSt35, comSt27, bdSt45, comSt21, bdSt46)
        gayathri_combination.append(comSt23, bdSt47, comSt28, bdSt48, comSt29, bdSt49, comSt30, bdSt50)
        if (sandyaType.equals("ப்ராத்தஸ்ந்தியா",true)) { gayathri_combination.append(bdSt51A) }
        else if (sandyaType.equals("மாத்யாநிஹம்",true)) { gayathri_combination.append(bdSt51B) }
        else { gayathri_combination.append(bdSt51C) }
        gayathri_combination.append(hdSt8, comSt31, bdSt52, comSt32, bdSt53, comSt33Missg, bdSt54Missg, comSt33, bdSt54, comSt34, bdSt55, hdSt9, comSt23, bdSt56)
        gayathri_combination.append(comSt21, bdSt57, comSt35, bdSt58, comSt36, bdSt59, comSt37, bdSt60, comSt38, bdSt61, comSt39, bdSt62)
        gayathri_combination.append(hdSt10, comSt40, bdSt63, hdSt11, comSt41, bdSt64, comSt42, bdSt65, comSt43, bdSt66, comSt44, bdSt67)
        gayathri_combination.append(comSt45, bdSt68, comSt25, bdSt69, hdSt12, comSt46, bdSt70, hdSt13, comSt17, bdSt16B, comSt18, bdSt17A)
        gayathri_combination.append(hdSt9A, comSt23, bdSt56A, comSt21, bdSt57A, comSt35, bdSt58A, comSt36, bdSt59A, comSt37, bdSt60A, comSt38Add, bdSt61Add, comSt47)
        gayathri_combination.append(bdSt71, hdSt10A, comSt25, bdSt72, hdSt11A, comSt41, bdSt73, comSt42, bdSt74, comSt43, bdSt75, comSt44)
        gayathri_combination.append(bdSt76, comSt45, bdSt77, comSt25, bdSt78, "\n", hdSt14, comSt48, bdSt79, comSt49, comSt49A, comSt49B, hdSt15, bdSt80, hdSt5A)
        gayathri_combination.append(bdSt20K, comSt50, hdSt16, comSt51, bdSt81, comSt52, bdSt82, comSt53, bdSt83, comSt54, bdSt84, comSt55, bdSt85)
        gayathri_combination.append(comSt56, bdSt86, comSt57, bdSt87, comSt58, bdSt88, comSt59, bdSt89, comSt60, bdSt90, comSt61, bdSt91, comSt62)
        gayathri_combination.append(bdSt92, comSt63, bdSt93, hdSt17, comSt64, bdSt94, hdSt18, bdSt95, hdSt19, comSt53, bdSt96, hdSt20, comSt57)
        gayathri_combination.append(bdSt97, hdSt21, comSt64, bdSt98, hdSt5B, bdSt20G, comSt50, hdSt22, comSt65, bdSt99, comSt66, bdSt100, comSt67, bdSt101, hdSt23)

        gayathri_combination.append("\n")
        binding.gayathrijapamTextView.text = gayathri_combination
        ...
        class MyPrintDocumentAdapter(private var context: Context) : PrintDocumentAdapter() {
            ...
            private fun drawPage(page: PdfDocument.Page, pagnumber: Int) {
                ...
                pageOneText = gayathri_combination.subSequence(startPos1, endPos1)
                pageTwoText = gayathri_combination.subSequence(startPos2, endPos2)
                pageThreeText = gayathri_combination.subSequence(startPos3, endPos3)
                pageFourText = gayathri_combination.subSequence(startPos4, endPos4)
                pageFiveText = gayathri_combination.subSequence(startPos5, endPos5)
                pageSixText = gayathri_combination.subSequence(startPos6, endPos6)
                pageSevenText = gayathri_combination.subSequence(startPos7, endPos7)
                pageEightText = gayathri_combination.subSequence(startPos8, endPos8)
                pageNineText = gayathri_combination.subSequence(startPos9, endPos9)
                pageTenText = gayathri_combination.subSequence(startPos10, endPos10)
                pageElevenText = gayathri_combination.subSequence(startPos11, endPos11)
                pageTwelveText = gayathri_combination.subSequence(startPos12, endPos12)
                pageThirteenText = gayathri_combination.subSequence(startPos13, endPos13)
                pageFourteenText = gayathri_combination.subSequence(startPos14, endPos14)
                pageFifteenText = gayathri_combination.subSequence(startPos15, endPos15)
                pageSixteenText = gayathri_combination.subSequence(startPos16, endPos16)
                pageSeventeenText = gayathri_combination.subSequence(startPos17, endPos17)

                val footerText1 = SpannableString(
                    "$heading (Page No. $pagnumber of $totalpages)"
                )
                footerText1.setSpan(AbsoluteSizeSpan(10, true), start, footerText1.length, exExFlag)
