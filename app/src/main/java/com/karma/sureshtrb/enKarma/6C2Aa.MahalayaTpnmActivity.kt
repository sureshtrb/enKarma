...
override fun onCreate(savedInstanceState: Bundle?) {
    ...
    val reVars = arrayOf(::reOne, ::reTwo, ::reThree, ::reFour, ::reFive, ::reSix, ::reSeven, ::reEight, ::reNine, ::reTen, ::reEleven, ::reTwelve, ::reThirteen, ::reFourteen, ::reFifteen);
    val gndrVars = arrayOf(::Gndr1, ::Gndr2, ::Gndr3, ::Gndr4, ::Gndr5, ::Gndr6, ::Gndr7, ::Gndr8, ::Gndr9, ::Gndr10, ::Gndr11, ::Gndr12, ::Gndr13, ::Gndr14, ::Gndr15)
    for (i in 0 until 15) {
...
pageNumber++
    ...
    val pageTexts = arrayOf(
        maha_combination.subSequence(mstartPos1, mendPos1),
        maha_combination.subSequence(mstartPos2, mendPos2),
        maha_combination.subSequence(mstartPos3, mendPos3),
        maha_combination.subSequence(mstartPos4, mendPos4),
        maha_combination.subSequence(mstartPos5, mendPos5),
        maha_combination.subSequence(mstartPos6, mendPos6),
        maha_combination.subSequence(mstartPos7, mendPos7),
        maha_combination.subSequence(mstartPos8, mendPos8),
        maha_combination.subSequence(mstartPos9, mendPos9),
        maha_combination.subSequence(mstartPos10, mendPos10),
        maha_combination.subSequence(mstartPos11, mendPos11),
        maha_combination.subSequence(mstartPos12, mendPos12),
        maha_combination.subSequence(mstartPos13, mendPos13),
...
endPositions.add(binding.MahalayaTPNMTextView.layout.getLineEnd(endLine))
    ...
    val page4Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[3], endPositions[3]) /* Removed comma */
    val page5Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[4], endPositions[4]) /* Removed comma */
    val page6Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[5], endPositions[5]) /* Removed comma */
    val page7Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[6], endPositions[6]) /* Removed comma */
    val page8Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[7], endPositions[7]) /* Removed comma */
    val page9Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[8], endPositions[8]) /* Removed comma */
    val page10Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[9], endPositions[9]) /* Removed comma */
    val page11Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[10], endPositions[10]) /* Removed comma */
    val page12Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[11], endPositions[11]) /* Removed comma */
    val page13Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[12], endPositions[12]) /* Removed comma */
    val page14Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[13], endPositions[13]) /* Removed comma */
    val page15Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[14], endPositions[14]) /* Removed comma */
    val page16Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[15], endPositions[15]) /* Removed comma */
    val page17Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[16], endPositions[16]) /* Removed comma */
    val page18Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[17], endPositions[17]) /* Removed comma */
    val page19Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[18], endPositions[18]) /* Removed comma */
    val page20Text = binding.MahalayaTPNMTextView.text.toString().substring(startPositions[19], endPositions[19]) // Removed comma
    ...
    fun trial() {
        ...
        fun bottomPithruKoorcham() {
            ...
            val formattedTexts = listOf(
                ...
                FormattedText("\nB.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*240 strAdditionP3*/
                FormattedText("\nC.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*241 strAdditionP3P*/
                FormattedText("\nC.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*242 strAdditionP3cb*/
                FormattedText("\nC.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                ...
                FormattedText("\nC.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*244 strAdditionP4*/
                FormattedText("\nD.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*245 strAdditionP4db*/
                FormattedText("\nD.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*246 strAdditionP4dc*/
                FormattedText("\nD.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                ...
                FormattedText("\nD.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*248 strAdditionP5eb*/
                FormattedText("\nE.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*249 strAdditionP5ec*/
                FormattedText("\nE.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*250 strAdditionP6*/
                FormattedText("\nF.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*251 strAdditionP6fb*/
                FormattedText("\nF.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*252 strAdditionP6fc*/
                FormattedText("\nF.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*253 strAdditionP7*/
                FormattedText("\nG.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*254 strAdditionP7gb*/
                FormattedText("\nG.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*255 strAdditionP7gc*/
                FormattedText("\nG.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*256 strAdditionP8*/
                FormattedText("\nH.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*257 strAdditionP8hb*/
                FormattedText("\nH.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*258 strAdditionP8hc*/
                FormattedText("\nH.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*259 strAdditionP9*/
                FormattedText("\nI.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*260 strAdditionP9ib*/
                FormattedText("\nI.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*261 strAdditionP9ic*/
                FormattedText("\nI.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*262 strAdditionP10*/
                FormattedText("\nJ.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*263 strAdditionP10jb*/
                FormattedText("\nJ.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*264 strAdditionP10jc*/
                FormattedText("\nJ.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*265 strAdditionP11*/
                FormattedText("\nK.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*266 strAdditionP11kb*/
                FormattedText("\nK.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*267 strAdditionP11kc*/
                FormattedText("\nK.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*268 strAdditionP12*/
                FormattedText("\nL.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*269 strAdditionP12lb*/
                FormattedText("\nL.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*270 strAdditionP12lc*/
                FormattedText("\nL.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*271 strAdditionP13*/
                FormattedText("\nM.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*272 strAdditionP13mb*/
                FormattedText("\nM.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*273 strAdditionP13mc*/
                FormattedText("\nM.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*274 strAdditionP14*/
                FormattedText("\nN.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*275 strAdditionP14nb*/
                FormattedText("\nN.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*276 strAdditionP14nc*/
                FormattedText("\nN.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*277 strAdditionP15*/
                FormattedText("\nO.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*278 strAdditionP15ob*/
                FormattedText("\nO.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*279 strAdditionP15oc*/
                FormattedText("\nO.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*280 strAdditionP1P*/
                FormattedText("\nA.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*281 strAdditionNO1*/
                FormattedText(" 1.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*282 strAdditionNO1B*/
                FormattedText(" 1.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*283 strAdditionNO1C*/
                FormattedText(" 1.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                ...
                FormattedText(" 1.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*296 strAdditionNO2*/
                FormattedText(" 2.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*297 strAdditionNO2B*/
                FormattedText(" 2.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*298 strAdditionNO2C*/
                FormattedText(" 2.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                ...
                FormattedText(" 2.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*311 strAdditionNO3*/
                FormattedText(" 3.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*312 strAdditionNO3B*/
                FormattedText(" 3.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*313 strAdditionNO3C*/
                FormattedText(" 3.", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                ...
                /*326 strAdditionP1zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM1 கோத்ரா அஸ்மத் BORNORDER1 NEWRELATION1 NEWNAME1".replace(
                        """(NEWPERSONGOTHRAM1)""".toRegex(),
                        gtOne
                    ).replace("""(BORNORDER1)""".toRegex(), bOne)
                        .replace("""(NEWRELATION1)""".toRegex(), reOne)
                        .replace("""(NEWNAME1)""".toRegex(), nOne),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*327 strAdditionP1zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM1 கோத்ரா அஸ்மத் BORNORDER1 NEWRELATION1 NEWNAME1".replace(
                        """(NEWPERSONGOTHRAM1)""".toRegex(),
                        gtOne
                ...
                /*329 strAdditionP2zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM2 கோத்ரா அஸ்மத் BORNORDER2 NEWRELATION2 NEWNAME2".replace(
                        """(NEWPERSONGOTHRAM2)""".toRegex(),
                        gtTwo
                    ).replace("""(BORNORDER2)""".toRegex(), bTwo)
                        .replace("""(NEWRELATION2)""".toRegex(), reTwo)
                        .replace("""(NEWNAME2)""".toRegex(), nTwo),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*330 strAdditionP2zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM2 கோத்ரா அஸ்மத் BORNORDER2 NEWRELATION2 NEWNAME2".replace(
                        """(NEWPERSONGOTHRAM2)""".toRegex(),
                        gtTwo
                ...
                /*332 strAdditionP3zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM3 கோத்ரா அஸ்மத் BORNORDER3 NEWRELATION3 NEWNAME3".replace(
                        """(NEWPERSONGOTHRAM3)""".toRegex(),
                        gtThree
                    ).replace("""(BORNORDER3)""".toRegex(), bThree)
                        .replace("""(NEWRELATION3)""".toRegex(), reThree)
                        .replace("""(NEWNAME3)""".toRegex(), nThree),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*333 strAdditionP3zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM3 கோத்ரா அஸ்மத் BORNORDER3 NEWRELATION3 NEWNAME3".replace(
                        """(NEWPERSONGOTHRAM3)""".toRegex(),
                        gtThree
                ...
                /*335 strAdditionP4zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM4 கோத்ரா அஸ்மத் BORNORDER4 NEWRELATION4 NEWNAME4".replace(
                        """(NEWPERSONGOTHRAM4)""".toRegex(),
                        gtFour
                    ).replace("""(BORNORDER4)""".toRegex(), bFour)
                        .replace("""(NEWRELATION4)""".toRegex(), reFour)
                        .replace("""(NEWNAME4)""".toRegex(), nFour),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*336 strAdditionP4zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM4 கோத்ரா அஸ்மத் BORNORDER4 NEWRELATION4 NEWNAME4".replace(
                        """(NEWPERSONGOTHRAM4)""".toRegex(),
                        gtFour
                ...
                /*338 strAdditionP5zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM5 கோத்ரா அஸ்மத் BORNORDER5 NEWRELATION5 NEWNAME5".replace(
                        """(NEWPERSONGOTHRAM5)""".toRegex(),
                        gtFive
                    ).replace("""(BORNORDER5)""".toRegex(), bFive)
                        .replace("""(NEWRELATION5)""".toRegex(), reFive)
                        .replace("""(NEWNAME5)""".toRegex(), nFive),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*339 strAdditionP5zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM5 கோத்ரா அஸ்மத் BORNORDER5 NEWRELATION5 NEWNAME5".replace(
                        """(NEWPERSONGOTHRAM5)""".toRegex(),
                        gtFive
                ...
                /*341 strAdditionP6zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM6 கோத்ரா அஸ்மத் BORNORDER6 NEWRELATION6 NEWNAME6".replace(
                        """(NEWPERSONGOTHRAM6)""".toRegex(),
                        gtSix
                    ).replace("""(BORNORDER6)""".toRegex(), bSix)
                        .replace("""(NEWRELATION6)""".toRegex(), reSix)
                        .replace("""(NEWNAME6)""".toRegex(), nSix),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*342 strAdditionP6zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM6 கோத்ரா அஸ்மத் BORNORDER6 NEWRELATION6 NEWNAME6".replace(
                        """(NEWPERSONGOTHRAM6)""".toRegex(),
                        gtSix
                    ).replace("""(BORNORDER6)""".toRegex(), bSix)
                        .replace("""(NEWRELATION6)""".toRegex(), nSix)
                        .replace("""(NEWNAME6)""".toRegex(), nSix),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*343 strAdditionP6zMC*/
                FormattedText(
                    " NEWPERSONGOTHRAM6 கோத்ரா அஸ்மத் BORNORDER6 NEWRELATION6 NEWNAME6".replace(
                        """(NEWPERSONGOTHRAM6)""".toRegex(),
                        gtSix
                ...
                /*347 strAdditionP8zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM8 கோத்ரா அஸ்மத் BORNORDER8 NEWRELATION8 NEWNAME8".replace(
                        """(NEWPERSONGOTHRAM8)""".toRegex(),
                        gtEight
                    ).replace("""(BORNORDER8)""".toRegex(), bEight)
                        .replace("""(NEWRELATION8)""".toRegex(), reEight)
                        .replace("""(NEWNAME8)""".toRegex(), nEight),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*348 strAdditionP8zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM8 கோத்ரா அஸ்மத் BORNORDER8 NEWRELATION8 NEWNAME8".replace(
                        """(NEWPERSONGOTHRAM8)""".toRegex(),
                        gtEight
                ...
                /*350 strAdditionP9zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM9 கோத்ரா அஸ்மத் BORNORDER9 NEWRELATION9 NEWNAME9".replace(
                        """(NEWPERSONGOTHRAM9)""".toRegex(),
                        gtNine
                    ).replace("""(BORNORDER9)""".toRegex(), bNine)
                        .replace("""(NEWRELATION9)""".toRegex(), reNine)
                        .replace("""(NEWNAME9)""".toRegex(), nNine),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*351 strAdditionP9zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM9 கோத்ரா அஸ்மத் BORNORDER9 NEWRELATION9 NEWNAME9".replace(
                        """(NEWPERSONGOTHRAM9)""".toRegex(),
                        gtNine
                ...
                /*353 strAdditionP10zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM10 கோத்ரா அஸ்மத் BORNORDER10 NEWRELATION10 NEWNAME10".replace(
                        """(NEWPERSONGOTHRAM10)""".toRegex(),
                        gtTen
                    ).replace("""(BORNORDER10)""".toRegex(), bTen)
                        .replace("""(NEWRELATION10)""".toRegex(), reTen)
                        .replace("""(NEWNAME10)""".toRegex(), nTen),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*354 strAdditionP10zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM10 கோத்ரா அஸ்மத் BORNORDER10 NEWRELATION10 NEWNAME10".replace(
                        """(NEWPERSONGOTHRAM10)""".toRegex(),
                        gtTen
                ...
                /*356 strAdditionP11zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM11 கோத்ரா அஸ்மத் BORNORDER11 NEWRELATION11 NEWNAME11".replace(
                        """(NEWPERSONGOTHRAM11)""".toRegex(),
                        gtEleven
                    ).replace("""(BORNORDER11)""".toRegex(), bEleven)
                        .replace("""(NEWRELATION11)""".toRegex(), reEleven)
                        .replace("""(NEWNAME11)""".toRegex(), nEleven),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*357 strAdditionP11zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM11 கோத்ரா அஸ்மத் BORNORDER11 NEWRELATION11 NEWNAME11".replace(
                        """(NEWPERSONGOTHRAM11)""".toRegex(),
                        gtEleven
                ...
                /*359 strAdditionP12zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM12 கோத்ரா அஸ்மத் BORNORDER12 NEWRELATION12 NEWNAME12".replace(
                        """(NEWPERSONGOTHRAM12)""".toRegex(),
                        gtTwelve
                    ).replace("""(BORNORDER12)""".toRegex(), bTwelve)
                        .replace("""(NEWRELATION12)""".toRegex(), reTwelve)
                        .replace("""(NEWNAME12)""".toRegex(), nTwelve),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*360 strAdditionP12zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM12 கோத்ரா அஸ்மத் BORNORDER12 NEWRELATION12 NEWNAME12".replace(
                        """(NEWPERSONGOTHRAM12)""".toRegex(),
                        gtTwelve
                ...
                /*362 strAdditionP13zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM13 கோத்ரா அஸ்மத் BORNORDER13 NEWRELATION13 NEWNAME13".replace(
                        """(NEWPERSONGOTHRAM13)""".toRegex(),
                        gtThirteen
                    ).replace("""(BORNORDER13)""".toRegex(), bThirteen)
                        .replace("""(NEWRELATION13)""".toRegex(), reThirteen)
                        .replace("""(NEWNAME13)""".toRegex(), nThirteen),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*363 strAdditionP13zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM13 கோத்ரா அஸ்மத் BORNORDER13 NEWRELATION13 NEWNAME13".replace(
                        """(NEWPERSONGOTHRAM10)""".toRegex(),
                        gtThirteen
                ...
                /*365 strAdditionP14zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM14 கோத்ரா அஸ்மத் BORNORDER14 NEWRELATION14 NEWNAME14".replace(
                        """(NEWPERSONGOTHRAM14)""".toRegex(),
                        gtFourteen
                    ).replace("""(BORNORDER14)""".toRegex(), bFourteen)
                        .replace("""(NEWRELATION14)""".toRegex(), reFourteen)
                        .replace("""(NEWNAME14)""".toRegex(), nFourteen),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*366 strAdditionP14zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM14 கோத்ரா அஸ்மத் BORNORDER14 NEWRELATION14 NEWNAME14".replace(
                        """(NEWPERSONGOTHRAM14)""".toRegex(),
                        gtFourteen
                ...
                /*368 strAdditionP15zM*/
                FormattedText(
                    " NEWPERSONGOTHRAM15 கோத்ரா அஸ்மத் BORNORDER15 NEWRELATION15 NEWNAME15".replace(
                        """(NEWPERSONGOTHRAM15)""".toRegex(),
                        gtFifteen
                    ).replace("""(BORNORDER15)""".toRegex(), bFifteen)
                        .replace("""(NEWRELATION15)""".toRegex(), reFifteen)
                        .replace("""(NEWNAME15)""".toRegex(), nFifteen),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                /*369 strAdditionP15zMB*/
                FormattedText(
                    " NEWPERSONGOTHRAM15 கோத்ரா அஸ்மத் BORNORDER15 NEWRELATION15 NEWNAME15".replace(
                        """(NEWPERSONGOTHRAM15)""".toRegex(),
                        gtFifteen
                ...
                /*371 strAdditionP1aA1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*372 strAdditionP1aA2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*373 strAdditionP1aA3*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*374 strAdditionP1aB1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*375 strAdditionP1aB2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*376 strAdditionP1aC1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*377 strAdditionP1aC2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*378 strAdditionP1aC3*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*379 strAdditionP1aD1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*380 strAdditionP1aD2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*381 strAdditionP1aD3*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*382 strAdditionP1aE1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*383 strAdditionP1aE2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*384 strAdditionP1aE3*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*385 strAdditionP1aF1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*386 strAdditionP1aF2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*387 strAdditionP1aF3*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*388 strAdditionP1aG1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*389 strAdditionP1aG2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*390 strAdditionP1aG3*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*391 strAdditionP1aH1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*392 strAdditionP1aH2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*393 strAdditionP1aH3*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*394 strAdditionP1aI1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*395 strAdditionP1aI2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*396 strAdditionP1aI3*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*397 strAdditionP1aJ1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*398 strAdditionP1aJ2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*399 strAdditionP1aJ3*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*400 strAdditionP1aK1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*401 strAdditionP1aK2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*402 strAdditionP1aK3*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*403 strAdditionP1aL1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*404 strAdditionP1aL2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*405 strAdditionP1aL2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*406 strAdditionP1aM1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*407 strAdditionP1aM2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*408 strAdditionP1aM3*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*409 strAdditionP1aN1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*410 strAdditionP1aN2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*411 strAdditionP1aN3*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*412 strAdditionP1aO1*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*413 strAdditionP1aO2*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*414 strAdditionP1aO3*/
                FormattedText(" சர்மா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*415 strAdditionP1zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM1 கோத்ரா அஸ்மத் NEWRELATION1 NEWNAME1".replace(
                        """(NEWPERSONGOTHRAM1)""".toRegex(),
                        gtOne
                    ).replace("""(NEWRELATION1)""".toRegex(), reOne)
                        .replace("""(NEWNAME11)""".toRegex(), nOne),
                    14,
                    Typeface.BOLD,
                    Color.parseColor("#0000ee")
                ),
                ...
                /*418 strAdditionP2zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM2 கோத்ரா அஸ்மத்  NEWRELATION2 NEWNAME2".replace(
                        """(NEWPERSONGOTHRAM2)""".toRegex(),
                        gtTwo
                    ).replace("""(NEWRELATION2)""".toRegex(), reTwo)
                        .replace("""(NEWNAME2)""".toRegex(), nTwo),
                ...
                /*421 strAdditionP3zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM3 கோத்ரா அஸ்மத்  NEWRELATION3 NEWNAME3".replace(
                        """(NEWPERSONGOTHRAM3)""".toRegex(),
                        gtThree
                    ).replace("""(NEWRELATION3)""".toRegex(), reThree)
                        .replace("""(NEWNAME3)""".toRegex(), nThree),
                ...
                /*424 strAdditionP4zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM4 கோத்ரா அஸ்மத்   NEWRELATION4 NEWNAME4".replace(
                        """(NEWPERSONGOTHRAM4)""".toRegex(),
                        gtFour
                    ).replace("""(NEWRELATION4)""".toRegex(), reFour)
                        .replace("""(NEWNAME4)""".toRegex(), nFour),
                ...
                /*427 strAdditionP5zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM5 கோத்ரா அஸ்மத்  NEWRELATION5 NEWNAME5".replace(
                        """(NEWPERSONGOTHRAM5)""".toRegex(),
                        gtFive
                    ).replace("""(NEWRELATION5)""".toRegex(), reFive)
                        .replace("""(NEWNAME5)""".toRegex(), nFive),
                ...
                /*430 strAdditionP6zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM6 கோத்ரா அஸ்மத்  NEWRELATION6 NEWNAME6".replace(
                        """(NEWPERSONGOTHRAM6)""".toRegex(),
                        gtSix
                    ).replace("""(NEWRELATION6)""".toRegex(), reSix)
                        .replace("""(NEWNAME6)""".toRegex(), nSix),
                ...
                /*433 strAdditionP7zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM7 கோத்ரா அஸ்மத்  NEWRELATION7 NEWNAME7".replace(
                        """(NEWPERSONGOTHRAM7)""".toRegex(),
                        gtSeven
                    ).replace("""(NEWRELATION7)""".toRegex(), reSeven)
                        .replace("""(NEWNAME7)""".toRegex(), nSeven),
                ...
                /*436 strAdditionP8zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM8 கோத்ரா அஸ்மத்  NEWRELATION8 NEWNAME8".replace(
                        """(NEWPERSONGOTHRAM8)""".toRegex(),
                        gtEight
                    ).replace("""(NEWRELATION8)""".toRegex(), reEight)
                        .replace("""(NEWNAME8)""".toRegex(), nEight),
                ...
                /*439 strAdditionP9zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM9 கோத்ரா அஸ்மத்  NEWRELATION9 NEWNAME9".replace(
                        """(NEWPERSONGOTHRAM9)""".toRegex(),
                        gtNine
                    ).replace("""(NEWRELATION9)""".toRegex(), reNine)
                        .replace("""(NEWNAME9)""".toRegex(), nNine),
                ...
                /*442 strAdditionP10zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM10 கோத்ரா அஸ்மத்  NEWRELATION10 NEWNAME10".replace(
                        """(NEWPERSONGOTHRAM10)""".toRegex(),
                        gtTen
                    ).replace("""(NEWRELATION10)""".toRegex(), reTen)
                        .replace("""(NEWNAME10)""".toRegex(), nTen),
                ...
                /*445 strAdditionP11zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM11 கோத்ரா அஸ்மத்  NEWRELATION11 NEWNAME11".replace(
                        """(NEWPERSONGOTHRAM11)""".toRegex(),
                        gtEleven
                    ).replace("""(NEWRELATION11)""".toRegex(), reEleven)
                        .replace("""(NEWNAME11)""".toRegex(), nEleven),
                ...
                /*448 strAdditionP12zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM12 கோத்ரா அஸ்மத்  NEWRELATION12 NEWNAME12".replace(
                        """(NEWPERSONGOTHRAM12)""".toRegex(),
                        gtTwelve
                    ).replace("""(NEWRELATION12)""".toRegex(), reTwelve)
                        .replace("""(NEWNAME12)""".toRegex(), nTwelve),
                ...
                /*451 strAdditionP13zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM13 கோத்ரா அஸ்மத்  NEWRELATION13 NEWNAME13".replace(
                        """(NEWPERSONGOTHRAM13)""".toRegex(),
                        gtThirteen
                    ).replace("""(NEWRELATION13)""".toRegex(), reThirteen)
                        .replace("""(NEWNAME13)""".toRegex(), nThirteen),
                ...
                /*454 strAdditionP14zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM14 கோத்ரா அஸ்மத்  NEWRELATION14 NEWNAME14".replace(
                        """(NEWPERSONGOTHRAM14)""".toRegex(),
                        gtFourteen
                    ).replace("""(NEWRELATION14)""".toRegex(), reFourteen)
                        .replace("""(NEWNAME14)""".toRegex(), nFourteen),
                ...
                /*457 strAdditionP15zA*/
                FormattedText(
                    " NEWPERSONGOTHRAM15 கோத்ரா அஸ்மத்  NEWRELATION15 NEWNAME15".replace(
                        """(NEWPERSONGOTHRAM15)""".toRegex(),
                        gtFifteen
                    ).replace("""(NEWRELATION15)""".toRegex(), reFifteen)
                        .replace("""(NEWNAME15)""".toRegex(), nFifteen),
                ...
                /*460 strAdditionP1bA1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*461 strAdditionP1bA2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*462 strAdditionP1bA3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*463 strAdditionP1bB1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*464 strAdditionP1bB2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*465 strAdditionP1bB3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*466 strAdditionP1bC1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*467 strAdditionP1bC2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*468 strAdditionP1bC3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*469 strAdditionP1bD1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*470 strAdditionP1bD2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*471 strAdditionP1bD3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*472 strAdditionP1bE1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*473 strAdditionP1bE2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*474 strAdditionP1bE3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*475 strAdditionP1bF1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*476 strAdditionP1bF2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*477 strAdditionP1bF3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*478 strAdditionP1bG1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*479 strAdditionP1bG2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*480 strAdditionP1bG3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*481 strAdditionP1bH1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*482 strAdditionP1bH2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*483 strAdditionP1bH3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*484 strAdditionP1bI1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*485 strAdditionP1bI2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*486 strAdditionP1bI3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*487 strAdditionP1bJ1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*488 strAdditionP1bJ2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*489 strAdditionP1bJ3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*490 strAdditionP1bK1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*491 strAdditionP1bK2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*492 strAdditionP1bK3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*493 strAdditionP1bL1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*494 strAdditionP1bL2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*495 strAdditionP1bL3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*496 strAdditionP1bM1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*497 strAdditionP1bM2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*498 strAdditionP1bM3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*499 strAdditionP1bN1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*500 strAdditionP1bN2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*501 strAdditionP1bN3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*502 strAdditionP1bO1*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*503 strAdditionP1bO2*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*504 strAdditionP1bO3*/
                FormattedText(" நாமதேயா வஸுரூப", 14, Typeface.BOLD, Color.parseColor("#0000ee")),
                /*505 strAdditionP1cA1*/
                FormattedText(
...
/*Tharpanam- MotherMother - IV.a.b.c*/
        ...
        mBody9 = createFormattedString(
            ...
            formattedTexts[19].style,
            formattedTexts[19].color
        )
        mComment9 = createFormattedString(
            formattedTexts[18].text,
            formattedTexts[18].size,
            formattedTexts[18].style,
            formattedTexts[18].color
        )
        mComment10 = createFormattedString(
            formattedTexts[20].text,
            formattedTexts[20].size,
            formattedTexts[20].style,
            formattedTexts[20].color
        )
        mBody10 = createFormattedString(
            formattedTexts[21].text,
            formattedTexts[21].size,
            formattedTexts[21].style,
            formattedTexts[21].color
        )
        mComment11 = createFormattedString(
            formattedTexts[22].text,
            formattedTexts[22].size,
            formattedTexts[22].style,
            formattedTexts[22].color
        )
        mBody11 = createFormattedString(
            formattedTexts[23].text,
            formattedTexts[23].size,
            formattedTexts[23].style,
            formattedTexts[23].color
        )
        mComment12 = createFormattedString(
            formattedTexts[24].text,
            formattedTexts[24].size,
            formattedTexts[24].style,
            formattedTexts[24].color
        )
        mBody12 = createFormattedString(
            formattedTexts[25].text,
            formattedTexts[25].size,
            formattedTexts[25].style,
            formattedTexts[25].color
        )
        mComment13 = createFormattedString(
            formattedTexts[26].text,
            formattedTexts[26].size,
            formattedTexts[26].style,
            formattedTexts[26].color
        )
        mBody13 = createFormattedString(
            formattedTexts[27].text,
            formattedTexts[27].size,
            formattedTexts[27].style,
            formattedTexts[27].color
        )
        mComment14 = createFormattedString(
            formattedTexts[28].text,
            formattedTexts[28].size,
            formattedTexts[28].style,
            formattedTexts[28].color
        )
        mBody14 = createFormattedString(
            formattedTexts[29].text,
            formattedTexts[29].size,
            formattedTexts[29].style,
            formattedTexts[29].color
        )
        mComment15A = createFormattedString(
            formattedTexts[30].text,
            formattedTexts[30].size,
            formattedTexts[30].style,
            formattedTexts[30].color
        )
        mComment15B = createFormattedString(
            formattedTexts[31].text,
            formattedTexts[31].size,
            formattedTexts[31].style,
            formattedTexts[31].color
        )
        mComment15C = createFormattedString(
            formattedTexts[32].text,
            formattedTexts[32].size,
            formattedTexts[32].style,
            formattedTexts[32].color
        )
        mComment15D = createFormattedString(
            formattedTexts[33].text,
            formattedTexts[33].size,
            formattedTexts[33].style,
            formattedTexts[33].color
        )
        mComment15E = createFormattedString(
            formattedTexts[34].text,
            formattedTexts[34].size,
            formattedTexts[34].style,
            formattedTexts[34].color
        )
        mComment15F = createFormattedString(
            formattedTexts[35].text,
            formattedTexts[35].size,
            formattedTexts[35].style,
            formattedTexts[35].color
        )
        mBody15 = createFormattedString(
            formattedTexts[36].text,
            formattedTexts[36].size,
            formattedTexts[36].style,
            formattedTexts[36].color
        )
        mComment16 = createFormattedString(
            formattedTexts[37].text,
            formattedTexts[37].size,
            formattedTexts[37].style,
            formattedTexts[37].color
        )
        mBody16 = createFormattedString(
            formattedTexts[38].text,
            formattedTexts[38].size,
            formattedTexts[38].style,
            formattedTexts[38].color
        )
        mComment17 = createFormattedString(
            formattedTexts[39].text,
            formattedTexts[39].size,
            formattedTexts[39].style,
            formattedTexts[39].color
        )
        mHeading2 = createFormattedString(
            formattedTexts[40].text,
            formattedTexts[40].size,
            formattedTexts[40].style,
            formattedTexts[40].color
        )
        mBody17 = createFormattedString(
            formattedTexts[41].text,
            formattedTexts[41].size,
            formattedTexts[41].style,
            formattedTexts[41].color
        )
        mComment18 = createFormattedString(
            formattedTexts[42].text,
            formattedTexts[42].size,
            formattedTexts[42].style,
            formattedTexts[42].color
        )
        mBody18 = createFormattedString(
            formattedTexts[43].text,
            formattedTexts[43].size,
            formattedTexts[43].style,
            formattedTexts[43].color
        )
        mComment19 = createFormattedString(
            formattedTexts[44].text,
            formattedTexts[44].size,
            formattedTexts[44].style,
            formattedTexts[44].color
        )
        mBody19 = createFormattedString(
            formattedTexts[45].text,
            formattedTexts[45].size,
            formattedTexts[45].style,
            formattedTexts[45].color
        )
        mComment20 = createFormattedString(
            formattedTexts[46].text,
            formattedTexts[46].size,
            formattedTexts[46].style,
            formattedTexts[46].color
        )
        mBody20 = createFormattedString(
            formattedTexts[47].text,
            formattedTexts[47].size,
            formattedTexts[47].style,
            formattedTexts[47].color
        )
        mComment21 = createFormattedString(
            formattedTexts[48].text,
            formattedTexts[48].size,
            formattedTexts[48].style,
            formattedTexts[48].color
        )
        mBody21 = createFormattedString(
            formattedTexts[49].text,
            formattedTexts[49].size,
            formattedTexts[49].style,
            formattedTexts[49].color
        )
        mComment22 = createFormattedString(
            formattedTexts[50].text,
            formattedTexts[50].size,
            formattedTexts[50].style,
            formattedTexts[50].color
        )
        mBody22 = createFormattedString(
            formattedTexts[51].text,
            formattedTexts[51].size,
            formattedTexts[51].style,
            formattedTexts[51].color
        )
        mComment23 = createFormattedString(
            formattedTexts[52].text,
            formattedTexts[52].size,
            formattedTexts[52].style,
            formattedTexts[52].color
        )
        mBody23 = createFormattedString(
            formattedTexts[53].text,
            formattedTexts[53].size,
            formattedTexts[53].style,
            formattedTexts[53].color
        )
        mComment24 = createFormattedString(
            formattedTexts[54].text,
            formattedTexts[54].size,
            formattedTexts[54].style,
            formattedTexts[54].color
        )
        mBody24 = createFormattedString(
            formattedTexts[55].text,
            formattedTexts[55].size,
            formattedTexts[55].style,
            formattedTexts[55].color
        )
        mComment25 = createFormattedString(
            formattedTexts[56].text,
            formattedTexts[56].size,
            formattedTexts[56].style,
            formattedTexts[56].color
        )
        mBody25 = createFormattedString(
            formattedTexts[57].text,
            formattedTexts[57].size,
            formattedTexts[57].style,
            formattedTexts[57].color
        )
        mComment26 = createFormattedString(
            formattedTexts[58].text,
            formattedTexts[58].size,
            formattedTexts[58].style,
            formattedTexts[58].color
        )
        mBody26 = createFormattedString(
            formattedTexts[59].text,
            formattedTexts[59].size,
            formattedTexts[59].style,
            formattedTexts[59].color
        )
        mComment27 = createFormattedString(
            formattedTexts[60].text,
            formattedTexts[60].size,
            formattedTexts[60].style,
            formattedTexts[60].color
        )
        mBody27 = createFormattedString(
            formattedTexts[61].text,
            formattedTexts[61].size,
            formattedTexts[61].style,
            formattedTexts[61].color
        )
        mComment28 = createFormattedString(
            formattedTexts[62].text,
            formattedTexts[62].size,
            formattedTexts[62].style,
            formattedTexts[62].color
        )
        mBody28 = createFormattedString(
            formattedTexts[63].text,
            formattedTexts[63].size,
            formattedTexts[63].style,
            formattedTexts[63].color
        )
        mComment29 = createFormattedString(
            formattedTexts[64].text,
            formattedTexts[64].size,
            formattedTexts[64].style,
            formattedTexts[64].color
        )
        mBody29 = createFormattedString(
            formattedTexts[65].text,
            formattedTexts[65].size,
            formattedTexts[65].style,
            formattedTexts[65].color
        )
        mComment30 = createFormattedString(
            formattedTexts[66].text,
            formattedTexts[66].size,
            formattedTexts[66].style,
            formattedTexts[66].color
        )
        mBody30 = createFormattedString(
            formattedTexts[67].text,
            formattedTexts[67].size,
            formattedTexts[67].style,
            formattedTexts[67].color
        )
        mComment31 = createFormattedString(
            formattedTexts[68].text,
            formattedTexts[68].size,
            formattedTexts[68].style,
            formattedTexts[68].color
        )
        mBody31 = createFormattedString(
            formattedTexts[69].text,
            formattedTexts[59].size,
            formattedTexts[69].style,
            formattedTexts[69].color
        )
        mComment32 = createFormattedString(
            formattedTexts[70].text,
            formattedTexts[70].size,
            formattedTexts[70].style,
            formattedTexts[70].color
        )
        mBody32 = createFormattedString(
            formattedTexts[71].text,
            formattedTexts[71].size,
            formattedTexts[71].style,
            formattedTexts[71].color
        )
        mComment33 = createFormattedString(
            formattedTexts[72].text,
            formattedTexts[72].size,
            formattedTexts[72].style,
            formattedTexts[72].color
        )
        mBody33 = createFormattedString(
            formattedTexts[73].text,
            formattedTexts[73].size,
            formattedTexts[73].style,
            formattedTexts[73].color
        )
        mComment34 = createFormattedString(
            formattedTexts[74].text,
            formattedTexts[74].size,
            formattedTexts[74].style,
            formattedTexts[74].color
        )
        mBody34 = createFormattedString(
            formattedTexts[75].text,
            formattedTexts[75].size,
            formattedTexts[75].style,
            formattedTexts[75].color
        )
        mComment35 = createFormattedString(
            formattedTexts[76].text,
            formattedTexts[76].size,
            formattedTexts[76].style,
            formattedTexts[76].color
        )
        mBody35 = createFormattedString(
            formattedTexts[77].text,
            formattedTexts[77].size,
            formattedTexts[77].style,
            formattedTexts[77].color
        )
        mComment36 = createFormattedString(
            formattedTexts[78].text,
            formattedTexts[78].size,
            formattedTexts[78].style,
            formattedTexts[78].color
        )
        mBody36 = createFormattedString(
            formattedTexts[79].text,
            formattedTexts[79].size,
            formattedTexts[79].style,
            formattedTexts[79].color
        )
        mComment37 = createFormattedString(
            formattedTexts[80].text,
            formattedTexts[80].size,
            formattedTexts[80].style,
            formattedTexts[80].color
        )
        mBody37 = createFormattedString(
            formattedTexts[81].text,
            formattedTexts[81].size,
            formattedTexts[81].style,
            formattedTexts[81].color
        )
        mComment38A = createFormattedString(
            formattedTexts[82].text,
            formattedTexts[82].size,
            formattedTexts[82].style,
            formattedTexts[82].color
        )
        mRedComment1 = createFormattedString(
            formattedTexts[83].text,
            formattedTexts[83].size,
            formattedTexts[83].style,
            formattedTexts[83].color
        )
        mComment38B = createFormattedString(
            formattedTexts[84].text,
            formattedTexts[84].size,
            formattedTexts[84].style,
            formattedTexts[84].color
        )
        mBody38 = createFormattedString(
            formattedTexts[85].text,
            formattedTexts[85].size,
            formattedTexts[85].style,
            formattedTexts[85].color
        )
        mBody381 = createFormattedString(
            formattedTexts[86].text,
            formattedTexts[86].size,
            formattedTexts[86].style,
            formattedTexts[86].color
        )
        mBody39 = createFormattedString(
            formattedTexts[87].text,
            formattedTexts[87].size,
            formattedTexts[87].style,
            formattedTexts[87].color
        )
        mBody39B = createFormattedString(
            formattedTexts[88].text,
            formattedTexts[88].size,
            formattedTexts[88].style,
            formattedTexts[88].color
        )
        mBody40 = createFormattedString(
            formattedTexts[89].text,
            formattedTexts[89].size,
            formattedTexts[89].style,
            formattedTexts[89].color
        )
        mBody41 = createFormattedString(
            formattedTexts[90].text,
            formattedTexts[90].size,
            formattedTexts[90].style,
            formattedTexts[90].color
        )
        mBody39A = createFormattedString(
            formattedTexts[91].text,
            formattedTexts[91].size,
            formattedTexts[91].style,
            formattedTexts[91].color
        )
        mBody41B = createFormattedString(
            formattedTexts[92].text,
            formattedTexts[92].size,
            formattedTexts[92].style,
            formattedTexts[92].color
        )
        mBody42 = createFormattedString(
            formattedTexts[93].text,
            formattedTexts[93].size,
            formattedTexts[93].style,
            formattedTexts[93].color
        )
        mBody39FM = createFormattedString(
            formattedTexts[94].text,
            formattedTexts[94].size,
            formattedTexts[94].style,
            formattedTexts[94].color
        )
        mMBody38 = createFormattedString(
            formattedTexts[95].text,
            formattedTexts[95].size,
            formattedTexts[95].style,
            formattedTexts[95].color
        )
        mMBody38b = createFormattedString(
            formattedTexts[96].text,
            formattedTexts[96].size,
            formattedTexts[96].style,
            formattedTexts[96].color
        )
        mMBody41B = createFormattedString(
            formattedTexts[97].text,
            formattedTexts[97].size,
            formattedTexts[97].style,
            formattedTexts[97].color
        )
        mMBody41Bc = createFormattedString(
            formattedTexts[98].text,
            formattedTexts[98].size,
            formattedTexts[98].style,
            formattedTexts[98].color
        )
        mBody42Z = createFormattedString(
            formattedTexts[99].text,
            formattedTexts[99].size,
            formattedTexts[99].style,
            formattedTexts[99].color
        )
        mBody42ZA = createFormattedString(
            formattedTexts[100].text,
            formattedTexts[100].size,
            formattedTexts[100].style,
            formattedTexts[100].color
        )
        mBody42ZB = createFormattedString(
            formattedTexts[101].text,
            formattedTexts[101].size,
            formattedTexts[101].style,
            formattedTexts[101].color
        )
        mComment39 = createFormattedString(
            formattedTexts[102].text,
            formattedTexts[102].size,
            formattedTexts[102].style,
            formattedTexts[102].color
        )
        mGreenComment1 = createFormattedString(
            formattedTexts[103].text,
            formattedTexts[103].size,
            formattedTexts[103].style,
            formattedTexts[103].color
        )
        mComment40 = createFormattedString(
            formattedTexts[104].text,
            formattedTexts[104].size,
            formattedTexts[104].style,
            formattedTexts[104].color
        )
        mComment40Two = createFormattedString(
            formattedTexts[105].text,
            formattedTexts[105].size,
            formattedTexts[105].style,
            formattedTexts[105].color
        )
        mComment40Three = createFormattedString(
            formattedTexts[106].text,
            formattedTexts[106].size,
            formattedTexts[106].style,
            formattedTexts[106].color
        )
        mComment41 = createFormattedString(
            formattedTexts[107].text,
            formattedTexts[107].size,
            formattedTexts[107].style,
            formattedTexts[107].color
        )
        mRedComment2 = createFormattedString(
            formattedTexts[108].text,
            formattedTexts[108].size,
            formattedTexts[108].style,
            formattedTexts[108].color
        )
        mComment41A = createFormattedString(
            formattedTexts[109].text,
            formattedTexts[109].size,
            formattedTexts[109].style,
            formattedTexts[109].color
        )
        mComment41C = createFormattedString(
            formattedTexts[110].text,
            formattedTexts[110].size,
            formattedTexts[110].style,
            formattedTexts[110].color
        )
        mComment41D = createFormattedString(
            formattedTexts[111].text,
            formattedTexts[111].size,
            formattedTexts[111].style,
            formattedTexts[111].color
        )

        mHeading3 = createFormattedString(
            formattedTexts[112].text,
            formattedTexts[112].size,
            formattedTexts[112].style,
            formattedTexts[112].color
        )
        mComment42 = createFormattedString(
            formattedTexts[113].text,
            formattedTexts[113].size,
            formattedTexts[113].style,
            formattedTexts[113].color
        )
        mRedComment3 = createFormattedString(
            formattedTexts[114].text,
            formattedTexts[114].size,
            formattedTexts[114].style,
            formattedTexts[114].color
        )
        mComment42A = createFormattedString(
            formattedTexts[115].text,
            formattedTexts[115].size,
            formattedTexts[115].style,
            formattedTexts[115].color
        )
        mBody46 = createFormattedString(
            formattedTexts[116].text,
            formattedTexts[116].size,
            formattedTexts[116].style,
            formattedTexts[116].color
        )
        mBody48A = createFormattedString(
            formattedTexts[117].text,
            formattedTexts[117].size,
            formattedTexts[117].style,
            formattedTexts[117].color
        )
        mBody48B = createFormattedString(
            formattedTexts[118].text,
            formattedTexts[118].size,
            formattedTexts[118].style,
            formattedTexts[118].color
        )
        mBody49 = createFormattedString(
            formattedTexts[119].text,
            formattedTexts[119].size,
            formattedTexts[119].style,
            formattedTexts[119].color
        )
        mBody50 = createFormattedString(
            formattedTexts[120].text,
            formattedTexts[120].size,
            formattedTexts[120].style,
            formattedTexts[120].color
        )
        mBody51B = createFormattedString(
            formattedTexts[121].text,
            formattedTexts[121].size,
            formattedTexts[121].style,
            formattedTexts[121].color
        )
        mBody52 = createFormattedString(
            formattedTexts[122].text,
            formattedTexts[122].size,
            formattedTexts[122].style,
            formattedTexts[122].color
        )
        mComment43 = createFormattedString(
            formattedTexts[123].text,
            formattedTexts[123].size,
            formattedTexts[123].style,
            formattedTexts[123].color
        )
        mComment43A = createFormattedString(
            formattedTexts[124].text,
            formattedTexts[124].size,
            formattedTexts[124].style,
            formattedTexts[124].color
        )
        mComment44 = createFormattedString(
            formattedTexts[125].text,
            formattedTexts[125].size,
            formattedTexts[125].style,
            formattedTexts[125].color
        )


        mComment44A = createFormattedString(
            formattedTexts[126].text,
            formattedTexts[126].size,
            formattedTexts[126].style,
            formattedTexts[126].color
        )
        mComment45 = createFormattedString(
            formattedTexts[127].text,
            formattedTexts[127].size,
            formattedTexts[127].style,
            formattedTexts[127].color
        )
        mComment45A = createFormattedString(
            formattedTexts[128].text,
            formattedTexts[128].size,
            formattedTexts[128].style,
            formattedTexts[128].color
        )
        mHeading4 = createFormattedString(
            formattedTexts[129].text,
            formattedTexts[129].size,
            formattedTexts[129].style,
            formattedTexts[129].color
        )
        mComment46 = createFormattedString(
            formattedTexts[130].text,
            formattedTexts[130].size,
            formattedTexts[130].style,
            formattedTexts[130].color
        )
        mComment46A = createFormattedString(
            formattedTexts[131].text,
            formattedTexts[131].size,
            formattedTexts[131].style,
            formattedTexts[131].color
        )
        mBody53 = createFormattedString(
            formattedTexts[132].text,
            formattedTexts[132].size,
            formattedTexts[132].style,
            formattedTexts[132].color
        )
        mBody56 = createFormattedString(
            formattedTexts[133].text,
            formattedTexts[133].size,
            formattedTexts[133].style,
            formattedTexts[133].color
        )
        mBody55 = createFormattedString(
            formattedTexts[134].text,
            formattedTexts[134].size,
            formattedTexts[134].style,
            formattedTexts[134].color
        )
        mBody57 = createFormattedString(
            formattedTexts[135].text,
            formattedTexts[135].size,
            formattedTexts[135].style,
            formattedTexts[135].color
        )
        mBody58 = createFormattedString(
            formattedTexts[136].text,
            formattedTexts[136].size,
            formattedTexts[136].style,
            formattedTexts[136].color
        )
        mBody59B = createFormattedString(
            formattedTexts[137].text,
            formattedTexts[137].size,
            formattedTexts[137].style,
            formattedTexts[137].color
        )
        mBody60 = createFormattedString(
            formattedTexts[138].text,
            formattedTexts[138].size,
            formattedTexts[138].style,
            formattedTexts[138].color
        )
        mComment47 = createFormattedString(
            formattedTexts[139].text,
            formattedTexts[139].size,
            formattedTexts[139].style,
            formattedTexts[139].color
        )
        mComment47A = createFormattedString(
            formattedTexts[140].text,
            formattedTexts[140].size,
            formattedTexts[140].style,
            formattedTexts[140].color
        )
        mComment47B = createFormattedString(
            formattedTexts[141].text,
            formattedTexts[141].size,
            formattedTexts[141].style,
            formattedTexts[141].color
        )
        mBody61 = createFormattedString(
            formattedTexts[142].text,
            formattedTexts[142].size,
            formattedTexts[142].style,
            formattedTexts[142].color
        )
        mComment48 = createFormattedString(
            formattedTexts[143].text,
            formattedTexts[143].size,
            formattedTexts[143].style,
            formattedTexts[143].color
        )
        mComment48A = createFormattedString(
            formattedTexts[144].text,
            formattedTexts[144].size,
            formattedTexts[144].style,
            formattedTexts[144].color
        )
        mComment48B = createFormattedString(
            formattedTexts[145].text,
            formattedTexts[145].size,
            formattedTexts[145].style,
            formattedTexts[145].color
        )
        mComment48C = createFormattedString(
            formattedTexts[146].text,
            formattedTexts[146].size,
            formattedTexts[146].style,
            formattedTexts[146].color
        )
        mComment48E = createFormattedString(
            formattedTexts[147].text,
            formattedTexts[147].size,
            formattedTexts[147].style,
            formattedTexts[147].color
        )
        mComment49 = createFormattedString(
            formattedTexts[148].text,
            formattedTexts[148].size,
            formattedTexts[148].style,
            formattedTexts[148].color
        )
        mComment49A = createFormattedString(
            formattedTexts[149].text,
            formattedTexts[149].size,
            formattedTexts[149].style,
            formattedTexts[149].color
        )
        mComment49B = createFormattedString(
            formattedTexts[150].text,
            formattedTexts[150].size,
            formattedTexts[150].style,
            formattedTexts[150].color
        )
        mComment49C = createFormattedString(
            formattedTexts[151].text,
            formattedTexts[151].size,
            formattedTexts[151].style,
            formattedTexts[151].color
        )
        mComment49D = createFormattedString(
            formattedTexts[152].text,
            formattedTexts[152].size,
            formattedTexts[152].style,
            formattedTexts[152].color
        )
        mComment49E = createFormattedString(
            formattedTexts[153].text,
            formattedTexts[153].size,
            formattedTexts[153].style,
            formattedTexts[153].color
        )
        mComment50 = createFormattedString(
            formattedTexts[154].text,
            formattedTexts[154].size,
            formattedTexts[154].style,
            formattedTexts[154].color
        )
        mComment50A = createFormattedString(
            formattedTexts[155].text,
            formattedTexts[155].size,
            formattedTexts[155].style,
            formattedTexts[155].color
        )
        mComment50B = createFormattedString(
            formattedTexts[156].text,
            formattedTexts[156].size,
            formattedTexts[156].style,
            formattedTexts[156].color
        )
        mComment50C = createFormattedString(
            formattedTexts[157].text,
            formattedTexts[157].size,
            formattedTexts[157].style,
            formattedTexts[157].color
        )
        mComment50D = createFormattedString(
            formattedTexts[158].text,
            formattedTexts[158].size,
            formattedTexts[158].style,
            formattedTexts[158].color
        )
        mComment50E = createFormattedString(
            formattedTexts[159].text,
            formattedTexts[159].size,
            formattedTexts[159].style,
            formattedTexts[159].color
        )
        mComment42Middle = createFormattedString(
            formattedTexts[160].text,
            formattedTexts[160].size,
            formattedTexts[160].style,
            formattedTexts[160].color
        )
        mMBody46 = createFormattedString(
            formattedTexts[161].text,
            formattedTexts[161].size,
            formattedTexts[161].style,
            formattedTexts[161].color
        )
        mMBody51B = createFormattedString(
            formattedTexts[162].text,
            formattedTexts[162].size,
            formattedTexts[162].style,
            formattedTexts[162].color
        )
        mMHeading4 = createFormattedString(
            formattedTexts[163].text,
            formattedTexts[163].size,
            formattedTexts[163].style,
            formattedTexts[163].color
        )
        mMComment46 = createFormattedString(
            formattedTexts[164].text,
            formattedTexts[164].size,
            formattedTexts[164].style,
            formattedTexts[164].color
        )
        mMBody53 = createFormattedString(
            formattedTexts[165].text,
            formattedTexts[165].size,
            formattedTexts[165].style,
            formattedTexts[165].color
        )
        mMBody51C1 = createFormattedString(
            formattedTexts[166].text,
            formattedTexts[166].size,
            formattedTexts[166].style,
            formattedTexts[166].color
        )
        mMBody61 = createFormattedString(
            formattedTexts[167].text,
            formattedTexts[167].size,
            formattedTexts[167].style,
            formattedTexts[167].color
        )
        mComment42AP = createFormattedString(
            formattedTexts[168].text,
            formattedTexts[168].size,
            formattedTexts[168].style,
            formattedTexts[168].color
        )
        mBody46P = createFormattedString(
            formattedTexts[169].text,
            formattedTexts[169].size,
            formattedTexts[169].style,
            formattedTexts[169].color
        )
        mHeading4P = createFormattedString(
            formattedTexts[170].text,
            formattedTexts[170].size,
            formattedTexts[170].style,
            formattedTexts[170].color
        )
        mBody46PAS = createFormattedString(
            formattedTexts[171].text,
            formattedTexts[171].size,
            formattedTexts[171].style,
            formattedTexts[171].color
        )
        mBody61P = createFormattedString(
            formattedTexts[172].text,
            formattedTexts[172].size,
            formattedTexts[172].style,
            formattedTexts[172].color
        )
        mComment42AP1 = createFormattedString(
            formattedTexts[173].text,
            formattedTexts[173].size,
            formattedTexts[173].style,
            formattedTexts[173].color
        )
        mHeading4P1 = createFormattedString(
            formattedTexts[174].text,
            formattedTexts[174].size,
            formattedTexts[174].style,
            formattedTexts[174].color
        )
        mComment42AP2A = createFormattedString(
            formattedTexts[175].text,
            formattedTexts[175].size,
            formattedTexts[175].style,
            formattedTexts[175].color
        )
        mComment42AP2B = createFormattedString(
            formattedTexts[176].text,
            formattedTexts[176].size,
            formattedTexts[176].style,
            formattedTexts[176].color
        )
        mHeading5 = createFormattedString(
            formattedTexts[177].text,
            formattedTexts[177].size,
            formattedTexts[177].style,
            formattedTexts[177].color
        )
        mBody62 = createFormattedString(
            formattedTexts[178].text,
            formattedTexts[178].size,
            formattedTexts[178].style,
            formattedTexts[178].color
        )
        mBody64 = createFormattedString(
            formattedTexts[179].text,
            formattedTexts[179].size,
            formattedTexts[179].style,
            formattedTexts[179].color
        )
        mBody66 = createFormattedString(
            formattedTexts[180].text,
            formattedTexts[180].size,
            formattedTexts[180].style,
            formattedTexts[180].color
        )
        mBody68 = createFormattedString(
            formattedTexts[181].text,
            formattedTexts[181].size,
            formattedTexts[181].style,
            formattedTexts[181].color
        )
        mBody69 = createFormattedString(
            formattedTexts[182].text,
            formattedTexts[182].size,
            formattedTexts[182].style,
            formattedTexts[182].color
        )
        mBody70A = createFormattedString(
            formattedTexts[183].text,
            formattedTexts[183].size,
            formattedTexts[183].style,
            formattedTexts[183].color
        )
        mBody70B = createFormattedString(
            formattedTexts[184].text,
            formattedTexts[184].size,
            formattedTexts[184].style,
            formattedTexts[184].color
        )
        mBody71 = createFormattedString(
            formattedTexts[185].text,
            formattedTexts[185].size,
            formattedTexts[185].style,
            formattedTexts[185].color
        )
        mBody72 = createFormattedString(
            formattedTexts[186].text,
            formattedTexts[186].size,
            formattedTexts[186].style,
            formattedTexts[186].color
        )
        mBody73A = createFormattedString(
            formattedTexts[187].text,
            formattedTexts[187].size,
            formattedTexts[187].style,
            formattedTexts[187].color
        )
        mBody73B = createFormattedString(
            formattedTexts[188].text,
            formattedTexts[188].size,
            formattedTexts[188].style,
            formattedTexts[188].color
        )
        mBody74 = createFormattedString(
            formattedTexts[189].text,
            formattedTexts[189].size,
            formattedTexts[189].style,
            formattedTexts[189].color
        )
        mBody75 = createFormattedString(
            formattedTexts[190].text,
            formattedTexts[190].size,
            formattedTexts[190].style,
            formattedTexts[190].color
        )
        mBody76A = createFormattedString(
            formattedTexts[191].text,
            formattedTexts[191].size,
            formattedTexts[191].style,
            formattedTexts[191].color
        )
        mBody76B = createFormattedString(
            formattedTexts[192].text,
            formattedTexts[192].size,
            formattedTexts[192].style,
            formattedTexts[192].color
        )
        mBody77 = createFormattedString(
            formattedTexts[193].text,
            formattedTexts[193].size,
            formattedTexts[193].style,
            formattedTexts[193].color
        )
        mBody78 = createFormattedString(
            formattedTexts[194].text,
            formattedTexts[194].size,
            formattedTexts[194].style,
            formattedTexts[194].color
        )
        mBody79A = createFormattedString(
            formattedTexts[195].text,
            formattedTexts[195].size,
            formattedTexts[195].style,
            formattedTexts[195].color
        )
        mBody79B = createFormattedString(
            formattedTexts[196].text,
            formattedTexts[196].size,
            formattedTexts[196].style,
            formattedTexts[196].color
        )
        mBody80 = createFormattedString(
            formattedTexts[197].text,
            formattedTexts[197].size,
            formattedTexts[197].style,
            formattedTexts[197].color
        )
        mBody81 = createFormattedString(
            formattedTexts[198].text,
            formattedTexts[198].size,
            formattedTexts[198].style,
            formattedTexts[198].color
        )
        mBody82A = createFormattedString(
            formattedTexts[199].text,
            formattedTexts[199].size,
            formattedTexts[199].style,
            formattedTexts[199].color
        )
        mBody82B = createFormattedString(
            formattedTexts[200].text,
            formattedTexts[200].size,
            formattedTexts[200].style,
            formattedTexts[200].color
        )
        mBody83 = createFormattedString(
            formattedTexts[201].text,
            formattedTexts[201].size,
            formattedTexts[201].style,
            formattedTexts[201].color
        )
        mBody84 = createFormattedString(
            formattedTexts[202].text,
            formattedTexts[202].size,
            formattedTexts[202].style,
            formattedTexts[202].color
        )
        mBody85A = createFormattedString(
            formattedTexts[203].text,
            formattedTexts[203].size,
            formattedTexts[203].style,
            formattedTexts[203].color
        )
        mBody85B = createFormattedString(
            formattedTexts[204].text,
            formattedTexts[204].size,
            formattedTexts[204].style,
            formattedTexts[204].color
        )
        mBody86 = createFormattedString(
            formattedTexts[205].text,
            formattedTexts[205].size,
            formattedTexts[205].style,
            formattedTexts[205].color
        )
        mBody87 = createFormattedString(
            formattedTexts[206].text,
            formattedTexts[206].size,
            formattedTexts[206].style,
            formattedTexts[206].color
        )
        mBody62P = createFormattedString(
            formattedTexts[207].text,
            formattedTexts[207].size,
            formattedTexts[207].style,
            formattedTexts[207].color
        )
        mBody62P2 = createFormattedString(
            formattedTexts[208].text,
            formattedTexts[208].size,
            formattedTexts[208].style,
            formattedTexts[208].color
        )
        mBody62P3 = createFormattedString(
            formattedTexts[209].text,
            formattedTexts[209].size,
            formattedTexts[209].style,
            formattedTexts[209].color
        )
        mMHeading5mG = createFormattedString(
            formattedTexts[210].text,
            formattedTexts[210].size,
            formattedTexts[210].style,
            formattedTexts[210].color
        )
        mMBody62 = createFormattedString(
            formattedTexts[211].text,
            formattedTexts[211].size,
            formattedTexts[211].style,
            formattedTexts[211].color
        )
        mMBody63 = createFormattedString(
            formattedTexts[212].text,
            formattedTexts[212].size,
            formattedTexts[212].style,
            formattedTexts[212].color
        )
        mMBody64 = createFormattedString(
            formattedTexts[213].text,
            formattedTexts[213].size,
            formattedTexts[213].style,
            formattedTexts[213].color
        )
        mMBody66 = createFormattedString(
            formattedTexts[214].text,
            formattedTexts[214].size,
            formattedTexts[214].style,
            formattedTexts[214].color
        )
        mMBody68 = createFormattedString(
            formattedTexts[215].text,
            formattedTexts[215].size,
            formattedTexts[215].style,
            formattedTexts[215].color
        )
        mMBody69 = createFormattedString(
            formattedTexts[216].text,
            formattedTexts[216].size,
            formattedTexts[216].style,
            formattedTexts[216].color
        )
        mMBody71 = createFormattedString(
            formattedTexts[217].text,
            formattedTexts[217].size,
            formattedTexts[217].style,
            formattedTexts[217].color
        )
        mMBody72 = createFormattedString(
            formattedTexts[218].text,
            formattedTexts[218].size,
            formattedTexts[218].style,
            formattedTexts[218].color
        )
        mMBody74 = createFormattedString(
            formattedTexts[219].text,
            formattedTexts[219].size,
            formattedTexts[219].style,
            formattedTexts[219].color
        )
        mMBody75 = createFormattedString(
            formattedTexts[220].text,
            formattedTexts[220].size,
            formattedTexts[220].style,
            formattedTexts[220].color
        )
        mMBody62M = createFormattedString(
            formattedTexts[221].text,
            formattedTexts[221].size,
            formattedTexts[221].style,
            formattedTexts[221].color
        )
        mMBody63M = createFormattedString(
            formattedTexts[222].text,
            formattedTexts[222].size,
            formattedTexts[222].style,
            formattedTexts[222].color
        )
        mMBody64M = createFormattedString(
            formattedTexts[223].text,
            formattedTexts[223].size,
            formattedTexts[223].style,
            formattedTexts[223].color
        )
        mMBody66M = createFormattedString(
            formattedTexts[224].text,
            formattedTexts[224].size,
            formattedTexts[224].style,
            formattedTexts[224].color
        )
        mMBody68M = createFormattedString(
            formattedTexts[225].text,
            formattedTexts[225].size,
            formattedTexts[225].style,
            formattedTexts[225].color
        )
        mMBody69M = createFormattedString(
            formattedTexts[226].text,
            formattedTexts[226].size,
            formattedTexts[226].style,
            formattedTexts[226].color
        )
        mMBody71M = createFormattedString(
            formattedTexts[227].text,
            formattedTexts[227].size,
            formattedTexts[227].style,
            formattedTexts[227].color
        )
        mMBody72M = createFormattedString(
            formattedTexts[228].text,
            formattedTexts[228].size,
            formattedTexts[228].style,
            formattedTexts[228].color
        )
        mMBody74M = createFormattedString(
            formattedTexts[229].text,
            formattedTexts[229].size,
            formattedTexts[229].style,
            formattedTexts[229].color
        )
        mMBody75M = createFormattedString(
            formattedTexts[230].text,
            formattedTexts[230].size,
            formattedTexts[230].style,
            formattedTexts[230].color
        )
